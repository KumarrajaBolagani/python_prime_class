...
sentence = "My name is kumar raj bolagani from csbs section"
sentence1 = sentence.upper()
print(f"Uppercase: {sentence1}")
print(f"Occurences of 'M': {sentence1.count('M')}")

sentence = sentence.replace("raj", "raja")
print(f"Replaced: {sentence}")
print(f"Length: {len(sentence)}")
print(f"Sliced Substring: {sentence[:20]}")
